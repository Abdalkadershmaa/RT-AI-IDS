...
from .model_loader import ModelIntegrityError, load_sha256_manifest, verify_artifact_sha256
...
class ModelService:
    ...
    def _load_from_disk(self) -> LoadedModels:
        ...
        def _verify(path: Path) -> None:
            ...
            try:
                if manifest is None:
                    manifest = load_sha256_manifest(self.model_dir)
                verify_artifact_sha256(path, manifest)
