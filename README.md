...
# JWT_SECRET_KEY, and ADMIN_PASSWORD. Idempotent — refuses to
...
| `GET`  | `/api/v1/predict/{job_id}`    | JWT  | Poll cached prediction result (TTL bounded)     |
...
| `REDIS_URL`                    | redis in compose       | `redis://host:port/db`                                                   |
